...
public class Phone {
	...
	static final String accessKeyId = "LTAI6IZr4ssHpYvk";
	static final String accessKeySecret = "hZ6yaaEb1YVtkjfnS2xRkzaPwEZb4h";
	...
	public static SendSmsResponse sendSms(String phonenum, String code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("桔子ice");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_107925093");
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
		...
		// 必填-号码
		request.setPhoneNumber("15996510459");
		// 可选-流水号
	...
	public static void main(String[] args) throws ClientException, InterruptedException {
		...
		// 发短信
		SendSmsResponse response = sendSms("15996510459", code);
